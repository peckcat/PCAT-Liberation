...
switch (KP_liberation_arsenal) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\custom.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\rhsusaf.sqf";};
    case  3: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\3cbBAF.sqf";};
    case  4: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\gm_west.sqf";};
    case  5: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\gm_east.sqf";};
    case  6: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\csat.sqf";};
    case  7: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\unsung.sqf";};
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\sfp.sqf";};
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\bwmod.sqf";};
    case  10: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_nato_mtp.sqf";};
    case  11: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_nato_tropic.sqf";};
    case  12: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_nato_wdl.sqf";};
    case  13: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_csat_hex.sqf";};
    case  14: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_csat_ghex.sqf";};
    case  15: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_aaf.sqf";};
    case  16: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\vanilla_ldf.sqf";};
    case  17: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\custom_west.sqf";};
    case  18: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\custom_east.sqf";};
    case  19: {[] call compileFinal preprocessFileLineNumbers "presets\arsenal\custom_NATO.sqf";};
