...
GRLIB_arsenal_magazines = [
    ...
    "100Rnd_65x39_caseless_mag",                                    // 6.5 mm 100Rnd Sand Mag
    ...
    "ACE_100Rnd_65x39_caseless_mag_Tracer_Dim",                     // 6.5毫米100發低視度紅外線曳光彈 彈匣
    "ACE_30Rnd_65x39_caseless_mag_Tracer_Dim",                      // 6.5毫米30發低視度紅外線曳光彈 彈匣
...
GRLIB_arsenal_items = [
    ...
    "ACE_acc_pointer_green",                                        // Laser Pointer
