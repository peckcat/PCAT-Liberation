...
opfor_marksman = "rhsusf_usmc_marpat_wd_sniper_m110";                   // Marksman
...
opfor_mrap = "rhsusf_m1043_w_s";                                        // Humvee
opfor_mrap_armed = "rhsusf_m1025_w_s_m2";                               // Humvee (Armed)
...
opfor_ammobox_transport = "rhsusf_M977A4_BKIT_usarmy_wd";               // Ural-4320 Transport (Open) -> Has to be able to transport resource crates!
opfor_fuel_truck = "rhsusf_M978A4_BKIT_usarmy_wd";                      // Ural-4320 Fuel
opfor_ammo_truck = "rhsusf_M977A4_AMMO_usarmy_wd";                      // GAZ-66 Ammo
...
militia_squad = [
    ...
    "rhsusf_usmc_marpat_wd_sniper_m110",                                       // Marksman
...
militia_vehicles = [
    "rhsusf_m1025_w_s_m2",                                                 // Humvee (Armed)
    "RHS_M6_wd",
    "RHS_M6_wd",
...
opfor_vehicles_low_intensity = [
    "RHS_M6_wd",
    "RHS_M6_wd",
    "rhsusf_m1025_w_s_m2",                                                 // Humvee M2 (Armed)
    "rhsusf_m1025_w_s_m2",                                                 // Humvee M2 (Armed)
    "rhsusf_m1025_w_s_m2",                                                 // Humvee M2 (Armed)
    "rhsusf_stryker_m1126_m2_wd",                                          // Stryker M2
    "rhsusf_stryker_m1126_m2_wd",                                          // Stryker M2
    "rhsusf_m113_usarmy"                                                   // M113 M2
];

// Militia vehicles. Lightweight vehicle classnames the game will pick from randomly as sector defenders. Can also be empty for only infantry milita.
opfor_vehicles = [
    "rhsusf_m1025_w_s_m2",                                               // Humvee M2 (Armed)
    "rhsusf_m1043_w_s_m2",                                               // Humvee (Armed)
    "rhsusf_m1045_w_s",                                                  // Humvee (Armed)
    "rhsusf_m113_usarmy_supply",                                         // M113 50cal supply
    "rhsusf_m113_usarmy",                                                // M113 50cal
    "rhsusf_m113_usarmy_M240",                                           // M113 M240
    "rhsusf_CGRCAT1A2_M2_usmc_wd",                                       // MRAP M2
    "rhsusf_m1240a1_m2crows_usmc_wd",                                    // MRAP M2 Crows
    "rhsusf_stryker_m1126_m2_wd",                                        // Stryker M2
    "rhsusf_stryker_m1126_mk19_wd",                                      // Stryker mk19
    "RHS_M6_wd",                                                         // AA Bradley
    "RHS_M2A3_BUSKIII_wd",                                               // Bradley Busk 3
...
opfor_battlegroup_vehicles_low_intensity = [
    "rhsusf_m1025_w_s_m2",                                         // Humvee M2
    "rhsusf_m1025_w_s_m2",                                         // Humvee M2 (Armed)
    "rhsusf_m1025_w_s_m2",                                         // Humvee M2 (Armed)
    "rhsusf_M1078A1P2_WD_fmtv_usarmy",                             // M2 Truck
    "rhsusf_stryker_m1126_m2_wd",                                  // Stryker M2
    "RHS_M6_wd",                                                   // AA Bradley
    "rhsusf_m113_usarmy",                                          // M113 M2
    "RHS_AH1Z_wd",                                                 // AH1Z
...
opfor_battlegroup_vehicles = [
    "rhsusf_m1025_w_s_m2",                                              // Humvee M2 (Armed)
    "rhsusf_m1025_w_s_Mk19",                                            // Humvee Mk19 (Armed)
    "rhsusf_m966_w",                                                    // Humvee TOW (Armed)
    "rhsusf_M1078A1P2_WD_fmtv_usarmy",                                  // M2 Truck
    "rhsusf_M1078A1P2_WD_fmtv_usarmy",                                  // M2 Truck
    "rhsusf_m1240a1_m2crows_usmc_wd",                                   // MRAP M2 Crows
    "rhsusf_m1240a1_mk19crows_usmc_wd",                                 // MRAP MK19 Crows
    "rhsusf_m113_usarmy",                                               // M113 M2
    "RHS_M6_wd",                                                        // AA Bradley
    "RHS_M6_wd",                                                        // AA Bradley
    "rhsusf_stryker_m1126_m2_wd",                                       // Stryker M2
    ...
    "rhsusf_m1a2sep1wd_usarmy",                                         // M1A2 tank
    "rhsusf_m1a1hc_wd",                                                 // M1A1 hc
    "RHS_UH1Y",                                                         // UH-1Y MG
...
opfor_troup_transports = [
    "rhsusf_M1078A1P2_WD_fmtv_usarmy",                          // M2 Truck
    "rhsusf_M1078A1P2_WD_fmtv_usarmy",                          // M2 Truck
    "rhsusf_M1220_M153_M2_usarmy_wd",                           // MRAP M2
    "rhsusf_M1220_M153_MK19_usarmy_wd",                         // MRAP MK19
    "rhsusf_stryker_m1126_m2_wd",                               // Stryker M2
    "rhsusf_stryker_m1126_mk19_wd",                             // Stryker MK19
