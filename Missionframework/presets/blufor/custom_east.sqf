...
light_vehicles = [
    ["rksla3_aircraft_tug_opfor",30,0,15],
    ...
    ["O_LSV_02_unarmed_F",60,0,50],                                     // LSV Mk.II
    ["O_LSV_02_armed_F",60,60,50],                                      // LSV Mk.II (M134)
    ["O_LSV_02_AT_F",60,75,50],                                         // LSV Mk.II (Metis-M)
...
heavy_vehicles = [
    ...
    ["rhs_bmp3mera_msv",280,250,150],                                   // BMP-3
    ["rhs_bmd1r",200,150,100],                                          // BMD-1R
    ...
    ["rhs_t90sm_tv",600,450,300],                                       // T-90SM(obyekt 188sm)
    ["rhs_t90am_tv",600,350,300],                                       // T-90AM(obyekt 188am)
    ["rhs_t90a_tv",500,400,300],                                        // T-90A
    ["rhs_t90sab_tv",600,400,300],                                      // T-90SA (2016)
    ["rhs_t14_tv",600,500,400],                                         // T-14
    ["O_MBT_02_cannon_f",650,600,400],                                  // T-100 Black Eagle
    ["rhs_zsu234_aa",300,250,175],                                      // ZSU-23-4
    ["O_APC_Tracked_02_AA_F",500,500,300],                              // ZSU-35 Tigris
    ["rhs_2s1_tv",600,1000,300],                                        // 2S1
    ["rhs_2s3_tv",600,1250,300],                                        // 2S3M1
    ["rhs_sprut_vdv",350,250,200]                                       // 2S25
...
air_vehicles = [
    ...
    ["O_T_UAV_04_CAS_F",450,500,250],                                   // KH-3A Fenghuang
    ...
    ["RHS_Mi24P_vdv",500,600,250],                                      // Mi-24P
    ["rhs_mi28n_vvsc",650,600,300],                                     // Mi-28N
    ["O_Heli_Transport_04_F",500,0,200],                                // Mi-290
    ["O_Heli_Transport_04_box_F",500,0,200],                            // Mi-290 (Cargo)
    ["O_Heli_Transport_04_medevac_F",500,0,200],                        // Mi-290 (Medical)
    ["O_Heli_Light_02_dynamicLoadout_F",500,200,200],                   // PO-30 Orca
    ["O_T_VTOL_02_infantry_dynamicLoadout_F",800,0,550],                // Y-32 Xi'an (Infatry Transport)
    ["O_T_VTOL_02_vehicle_dynamicLoadout_F",800,0,550],                 // Y-32 Xi'an (Vehicle Transport)
    ["RHS_Su25SM_vvsc",900,900,400],                                    // Su-25SM
    ["O_Plane_CAS_02_dynamicLoadout_F",1500,1500,500],                  // Yak-130
    ["rhs_mig29s_vvsc",1000,1000,400],                                  // Mig-29S
    ["rhs_mig29sm_vvsc",1250,1250,450],                                 // Mig-29SM
    ["JS_JC_SU35",1800,1500,500],                                       // Su-35
    ["O_Plane_Fighter_02_F",1800,1700,600]                              // To-201 Shikra
];
