...
GRLIB_arsenal_weapons = [
    ...
    "srifle_GM6_ghex_F",                            // GM6 Lynx (Green Hex)
    "arifle_Katiba_F",                              // KH2002 Sama
    "arifle_Katiba_GL_F",                           // KH2002 Sama KGL
    ...
    "rhs_weap_ak74_npz",
    "rhs_weap_ak74_camo",
    "rhs_weap_ak74_camo_npz",
    "rhs_weap_ak74_desert",
    "rhs_weap_ak74_desert_npz",
    "rhs_weap_ak74_gp25",
    "rhs_weap_ak74_gp25_npz",
    ...
    "launch_O_Vorona_green_F",                                      // Metis-M (Green)
...
GRLIB_arsenal_magazines = [
    ...
    "1Rnd_SmokeWhite_Grenade_shell",                                // Smoke Round (White)
    ...
    "ACE_5Rnd_127x99_Mag",                                          // 12.7x99 mm 5Rnd Mag
    "ACE_5Rnd_127x99_AMAX_Mag",                                     // 12.7x99 mm 5Rnd Mag (AMAX)
    "ACE_5Rnd_127x99_Mag",                                          // 12.7x99 mm API 5Rnd Mag
    ...
    "rhs_VOG25P",
    // - RHS GREF
    "rhsgref_296Rnd_792x_57_SmE_belt",                              //296Rnd 792x57 Belt S.m.E
    "rhsgref_296Rnd_792x_57_SmE_notracers_belt",                    //296Rnd 792x57 Belt S.m.E(no tracers)
    "rhsgref_296Rnd_792X57_smk_belt",                               //296rnd 792x57 belt s.m.k
    "rhsgref_296Rnd_792X57_SmK_alltracers_belt",                    //296rnd 792x57 belt s.m.k.L'spur(ALL Tracers)
    "rhsgref_50Rnd_792x_57_SmE_drum",                               //50Rnd 792x57 Drum S.m.E
    "rhsgref_50Rnd_792x_57_SmE_notracers_drum",                     //50Rnd 792x57 Drum S.m.E(No tracers)
    "rhsgref_50Rnd_792x57_SmK_drum",                                //50Rnd 7.92x57 Drum S.m.K
    "rhsgref_50Rnd_792X57_SmK_alltracers_drum",                     //50Rnd 7.92x57 Drum S.m.K.L"spur(All tracers)
...
GRLIB_arsenal_items = [
    ...
    "rhs_6b13_Flora_headset_mapcase",
    "rhs_6b13_Flora_radio",
    "rhs_6b13_Flora_vog",
    "rhs_6b13_Flora",
    "rhs_6b13",
    "rhs_6b2_AK",
    ...
    "ace dragon_sight",                                             // SU-36/P Daysight
    // - RHS AFRF
    "rhs_pdu4",                                                     // PDU-4
    ...
    "ACE_Canteen_Empty",                                            // Canteen (Empty)
    "ACE_Canteen_Half",                                             // Canteen (Half)
    "ACE_Canteen",                                                  // Canteen
    ...
    "ACE_salineIV_500",
    "ACE_salineIV",
    "ACE_SpareBarrel_Item",                                         // Spare barrel
    "ACE_splint",                                                   // Splint
